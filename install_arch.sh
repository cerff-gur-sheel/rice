...
DESCRIPTION
  this is a script that automatically installs the cerff_gur_sheel setup, 
  available at https://github.com/cerff-gur-sheel/rice
  
OPTIONS
  -h, --help                        Show this help message and exit.
  -R, --reboot-on-finish            Restarts the system automatically after installation
...
hwclock --systohc
echo "[INFO] Timezone set to America/Sao_Paulo"
